"""Google Calendar API (v3) への読み書き。google_auth.pyと同じOAuth2リフレッシュトークン方式。
...
from .google_auth import get_access_token  # noqa: F401 (handle_issue.pyから re-export として参照される)
